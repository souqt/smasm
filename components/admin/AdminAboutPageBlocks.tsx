...
const AdminAboutPageBlocks = () => {
  return (
    <AdminPageBlocks
      pageKey="about"
      pageTitle="About Us Page"
      pageDescription="Manage the About Us page content using the block system"
      defaultBlocks={defaultAboutBlocks}
    />
  );
};

export default AdminAboutPageBlocks;
